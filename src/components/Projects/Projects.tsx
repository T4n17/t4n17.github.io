...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A comprehensive infrastructure monitoring solution using Prometheus and Grafana.',
    technologies: ['Prometheus', 'Grafana', 'Docker', 'Logging', 'Performance Monitoring'],
    icon: <SecurityIcon sx={{ fontSize: 40, color: '#00f2ff', filter: 'drop-shadow(0 0 5px rgba(0, 242, 255, 0.5))' }} />,
    url: 'https://github.com/T4n17/inframonitor'
  },
  {
    title: 'Docker Development Lab',
    description: 'A secure containerized development environment with SSH access and security hardening features.',
